defmodule SimpleSyllabusReporter.Syllabi.SyncWorker do
  require Logger

  alias SimpleSyllabusReporter.SimpleSyllabusApi

  alias SimpleSyllabusReporter.Syllabi.{
    SyllabusDB,
      ...
      {:ok, schools, total_schools} ->
        ...
        case fetch_all_orgs_syllabi_metadata(term_id: term_id, schools: schools) do
          ...
          {:ok, all_syllabi} ->
            ...
            SimpleSyllabusReporter.Syllabi.Syncing.SyllabusScraperAgent.report_syllabi_to_sync(
            ...
            |> Enum.reduce_while(:ok, fn task_result, :ok ->
              case task_result do
                {:ok, :ok} ->
                  SimpleSyllabusReporter.Syllabi.Syncing.SyllabusScraperAgent.report_syllabus_synced()
                  {:cont, :ok}

                {:ok, {:error, reason}} ->
                  SimpleSyllabusReporter.Syllabi.Syncing.SyllabusScraperAgent.report_sync_error(
                    reason
                  )
